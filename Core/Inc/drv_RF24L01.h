...
/** 口线操作函数定义 */
#define RF24L01_SET_CE_HIGH( )			 LL_GPIO_SetOutputPin(NRF24_CE_GPIO_Port,NRF24_CE_Pin)
#define RF24L01_SET_CE_LOW( )			 LL_GPIO_ResetOutputPin(NRF24_CE_GPIO_Port,NRF24_CE_Pin)

//void t(){
//    LL_GPIO_IsInputPinSet(NRF24_IRQ_GPIO_Port,NRF24_IRQ_Pin);
//}

#define RF24L01_SET_CS_HIGH( )			LL_GPIO_SetOutputPin(NRF24_CS_GPIO_Port,NRF24_CS_Pin)
#define RF24L01_SET_CS_LOW( )			LL_GPIO_ResetOutputPin(NRF24_CS_GPIO_Port,NRF24_CS_Pin)

#define RF24L01_GET_IRQ_STATUS( )		 LL_GPIO_IsInputPinSet(NRF24_IRQ_GPIO_Port,NRF24_IRQ_Pin)
